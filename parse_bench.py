...
nshares = int(sys.argv[3])
ds = np.arange(2,nshares)
rnd_name = target+"_"+subtarget+"_rnd.csv"
cycles_name = target+"_"+subtarget+"_cycles.csv"
plot_RND = False
...
if __name__ == "__main__":
    ...
    if plot_RND:
        ...
        plt.legend()
        plt.grid(True,which="both",ls="--")
        plt.savefig("report-bench-rnd.pdf")
